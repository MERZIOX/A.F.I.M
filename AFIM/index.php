                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Inicio <small>Lorem ipsum dolor sit</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <form action="">
                        ...
                        <div class="col-lg-4">
                            <form action="">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="form-control" type="email" placeholder="Sebastian_43@correo.com"
                                        required>
                                </div>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="date" id="fecha" name="fecha" value="" min="2010-01-01" max="2018-12-31">
                        </div>
                        <div class="col-lg-4">
